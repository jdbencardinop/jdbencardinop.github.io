...
var numpreguntas = [5, 5, 5, 5, 5, 5];

var preguntas = [];
for (var i = 1; i <= 6; i++) {
    for (var j = 0; j <= numpreguntas[i - 1]; j++) {
        var img = document.getElementById("i" + j + "" + i);

        img.onclick = function () {
            modal.style.display = "block";
            //modalImg.src = "Imagenes/Mercurio.png";
            captionText.innerHTML = "Planeta Mercurio";
        }
    }
}
